...
```razor
<RTBlazorfied Id="editor1" @ref="_editor" @bind-Value="@_html" Class="@_theme" />
...
Complete ready-to-use implementations of Microsoft's [Fluent 2 Design System](https://fluent2.microsoft.design/). Copy the CSS block into your app.css or site.css and apply the class to your RTBlazorfied component.
